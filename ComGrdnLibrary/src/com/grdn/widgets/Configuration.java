...
public class Configuration implements Cloneable {
	...
	static class Default {
		static int DEFAULT_OFF_COLOR = Color.parseColor("#99cdff");//Color.parseColor("#E3E3E3");
		static int DEFAULT_ON_COLOR = Color.parseColor("#0080ff");//Color.parseColor("#02BFE7");
