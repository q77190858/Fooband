...
public class CropUtil {
     ...
     * @return 本地文件
     */
    public static File makeTempFile(Context context, Uri uri, String cacheFullPath, boolean isRoate) {
        Bitmap photo = null;
        ...
        if (photo != null) {
            ...
            try {
                ...
                byte[] bmpBytes = compressPhotoByte(photo, isRoate);
                fos.write(bmpBytes);
                fos.flush();
     ...
     * @return
     */
    public static byte[] compressPhotoByte(Bitmap sBmp, boolean isRoate) {
        int w = sBmp.getWidth();
